...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "workcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"workcointools.com", "dnsseed.workcointools.com"},
    {"workcoinpool.org", "dnsseed.workcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"workcointools.com", "testnet-seed.workcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. workcoin is probably already running."), addrBind.ToString().c_str());
        else
